...
class MessagingInMemory[F[_], A](topic: Topic[F, A], config: MessagingConfig)(implicit F: Sync[F])
...
object MessagingInMemory {
  def make[F[_], A](config: MessagingConfig)(implicit F: Async[F]): F[MessagingInMemory[F, A]] = {
    Topic[F, A]
